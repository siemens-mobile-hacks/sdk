...
#ifdef SWILIB_MODERN
	TCI_HEADLINE_DEFAULT			= 0x0,
	TCI_HEADLINE_FULLSCREEN			= 0x1,
	TCI_BODY_DEFAULT				= 0x2,
	TCI_BODY_TAB					= 0x3,
	TCI_BOTTOM_DEFAULT				= 0x4,
	TCI_BOTTOM_FULLSCREEN			= 0x5,
	TCI_POPUP_OPTIONS				= 0x6,
	TCI_POPUP_FEEDBACK				= 0x7,
	TCI_SELECTION_1_LINE			= 0x8,
	TCI_SELECTION_2_LINE			= 0x9,
	TCI_SELECTION_3_LINE			= 0xA,
	TCI_SELECTION_ICON_ONLY			= 0xB,
	TCI_POPUP_SEARCH_FIELD			= 0xC,
	TCI_POPUP_QUICK_ACCESS_FIELD	= 0xD,
	TCI_PROGRESS_BAR				= 0xE,
	TCI_TAB_SELECTED				= 0xF,
	TCI_TAB_UNSELECTED				= 0x10,
	TCI_STATUS_BAR_STANDARD			= 0x11,
	TCI_STATUS_BAR_FULLSCREEN		= 0x12,
#else
...
__swi_end(0x2FB, PIT_ClearCache, ());
